"""
This module provides bounding volume hierarchy (BVH) acceleration for DiffeRT's ray-triangle intersection queries.

.. warning::
    These APIs are experimental and may change in the near future.
    See the discussion in (TODO: issue link) for details.
...
from ._triangle_bvh import TriangleBvh
