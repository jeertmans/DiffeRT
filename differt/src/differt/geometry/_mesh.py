...
_T = TypeVar("_T", bound="Mesh")


class _MeshVerticesUpdateHelper(Generic[_T]):
    ...
    def __getitem__(self, index: _Index) -> "_MeshVerticesUpdateRef[_T]":
        return _MeshVerticesUpdateRef(self.mesh, index)

    def __repr__(self) -> str:
        return f"_MeshVerticesUpdateHelper({self.mesh!r})"


class _MeshVerticesUpdateRef(Generic[_T]):
    ...
    def __repr__(self) -> str:
        return f"_MeshVerticesUpdateRef({self.mesh!r}, {self.index!r})"
...
class Mesh(eqx.Module):
    ...
    def set_assume_quads(self, flag: bool = True) -> Self:
        ...
        Returns:
            A new mesh with the same structure with :attr:`Mesh.assume_quads<differt.geometry.Mesh.assume_quads>` set to ``flag``.
        """
    ...
    @classmethod
    def from_core(cls, core_mesh: differt_core.geometry.Mesh) -> Self:
        """
    ...
    def at(self):  # ruff:ignore[missing-return-type-private-function]
        ...
        Examples:
            ...
            .. plotly::
                ...
                >>> mesh = Mesh.box().at[0:2].add([1.0, 1.0, 0.0])
                >>> fig = mesh.plot(opacity=0.5, backend="plotly")
                >>> fig  # doctest: +SKIP
            ...
            >>> mesh = Mesh.box()
            >>> mesh.at
            _MeshVerticesUpdateHelper(Mesh(
              vertices=f32[8,3],
              triangles=i32[10,3],
              material_names=(),
            ...
            got (2,), expected (10,)
        """
        return _MeshVerticesUpdateHelper(self)
    ...
    def append(self, other: "Mesh") -> Self:
        """
        ...
        Examples:
            ...
            .. plotly::
                ...
                >>> for i in range(3):
                ...     size = 1.0 / (i + 1)
                ...     mesh += Mesh.box(length=size, width=size, height=size)
    ...
    def load_obj(cls, file: str) -> Self:
        ...
        """
        core_mesh = differt_core.geometry.Mesh.load_obj(file)
    ...
    def load_ply(cls, file: str) -> Self:
        ...
        Returns:
            The corresponding mesh containing only triangles.
        """
        core_mesh = differt_core.geometry.Mesh.load_ply(file)
        return cls.from_core(core_mesh)
    ...
    def center(self) -> Self:
        ...
        Examples:
            ...
            .. plotly::
                ...
                >>> from differt.geometry import Mesh
                >>>
                >>> mesh = Mesh.box(length=4.0, width=2.0, height=1.0).translate(
