...
def fermat_path_on_linear_objects(
    ...
    *,
    ...
    Args:
        ...
        use_image_method: Whether to solve specular reflections/transmissions in closed form
            via the image method, leaving only diffracting edges to be optimized. This is
            faster and more accurate than jointly optimizing every object's coordinates, and
            should only be disabled for testing or debugging purposes.
