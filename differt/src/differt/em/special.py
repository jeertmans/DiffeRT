...
def fresnel(
    ...
    The real-valued arguments implementation uses :func:`jax.scipy.fresnel`,
    and should be very accurate. This implementation was developed for
    this package, but was then added to the JAX ecosystem in
    `#22843 <https://github.com/google/jax/pull/22843>`_.
