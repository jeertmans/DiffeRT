...
class TriangleMeshScene(Scene):
    ...
    @classmethod
    def load_geojson(cls, file: Path, default_height: float = 1.0) -> TriangleMeshScene:
        pass

    @classmethod
    def load_obj(cls, file: Path) -> TriangleMeshScene:
        mesh = o3d.io.read_triangle_mesh(file).compute_triangle_normals()
