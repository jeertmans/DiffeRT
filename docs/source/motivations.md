...
[^2]: There are some exceptions, like the internal machinery behind
  {meth}`TriangleScene.compute_paths<differt.geometry.TriangleScene.compute_paths>`,
