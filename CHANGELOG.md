...
- Implemented {func}`slab_coefficients<differt.em.slab_coefficients>`, the shared reflection/transmission slab formula (by <gh-user:jeertmans>, in <gh-pr:460>).
